...
process ENHANCED_VOLCANO_SHORT {
    container 'https://depot.galaxyproject.org/singularity/bioconductor-enhancedvolcano:1.24.0--r44hdfd78af_0'
    publishDir "${params.output_dir}/short_read/05_differential_expression/plots/volcano", mode: 'copy'
    ...
    names(keyvals)[keyvals == 'royalblue3'] <- 'High in Ureter'
