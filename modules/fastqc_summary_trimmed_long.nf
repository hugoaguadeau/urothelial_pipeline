// Process: FastQC Summary - Extract key metrics from trimmed reads (Long Reads)
process FASTQC_SUMMARY_TRIMMED_LONG {
    ...
    for (zip_file in zip_files) {
        ...
        sample_id <- sub("-fastplong-output_reads_fastqc[.]zip\$", "", basename(zip_file))
    ...
    cat("================================================================================\\n")
    cat("                   FASTQC SUMMARY - TRIMMED LONG READS\\n")
    cat("================================================================================\\n\\n")
    cat("Quality control metrics after Pychopper and Fastplong processing\\n")
    ...
    cat("================================================================================\\n")
    cat("OVERALL SUMMARY (AFTER PROCESSING):\\n")
    cat("--------------------------------------------------------------------------------\\n")
