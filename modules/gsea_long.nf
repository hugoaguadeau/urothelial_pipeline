// Process: GSEA - Gene Set Enrichment Analysis (Long Reads)
...
process GSEA_LONG {
    ...
    publishDir "${params.output_dir}/long_read/05_differential_expression/gsea", mode: 'copy'
    ...
    create_enrichment_plot <- function(gsea_df, pathway_name, output_file) {
        ...
        # Note: Using padj for selecting 'top' pathways for plotting
    ...
    # 2. Nominal P-value Significant (Requested Addition)
