// Process: PCA Eigenvectors Summary (Long Reads)
// Creates a human-readable text summary of the PCA eigenvector analysis results
process PCA_EIGENVECTORS_SUMMARY_LONG {
    ...
    # ========================================================================
    # PCA EIGENVECTORS SUMMARY - LONG READS
    # ========================================================================
    ...
    # ========================================================================
    cat("================================================================================\\n")
    cat("            PCA EIGENVECTORS ANALYSIS SUMMARY (LONG READS)\\n")
    cat("================================================================================\\n\\n")
