// Process: SeqKit Statistical Analysis - Trimmed Long Reads
process SEQKIT_STATS_ANALYSIS_TRIMMED_LONG {
    ...
    cat("                         LONG READS (AFTER PROCESSING)\\n")
    cat("================================================================================\\n\\n")
    cat("Analysis of quality metrics after Pychopper and Fastplong processing\\n")
    ...
    cat("================================================================================\\n")
    cat("SUMMARY ACROSS ALL SAMPLES (AFTER PROCESSING):\\n")
    cat("--------------------------------------------------------------------------------\\n")
    ...
    if (nrow(bladder_samples) < 2 || nrow(ureter_samples) < 2) {
        ...
        cat("                         LONG READS (AFTER PROCESSING)\\n")
        cat("================================================================================\\n\\n")
        cat("Statistical comparison after Pychopper and Fastplong processing\\n")
