// Process: SeqKit Statistical Analysis - Trimmed Reads
process SEQKIT_STATS_ANALYSIS_TRIMMED_SHORT {
    ...
    input:
    path seqkit_summary  // The trimmed seqkit summary CSV
    path sample_info     // samples.csv to get tissue groups

    output:
    path "trimmed_sample_statistics.csv", emit: sample_stats
    path "trimmed_sample_statistics.txt", emit: sample_stats_txt
    path "trimmed_read_pair_comparison.csv", emit: pair_comparison
    path "trimmed_read_pair_comparison.txt", emit: pair_comparison_txt
    path "trimmed_group_statistics.csv", emit: group_stats
    path "trimmed_group_statistics.txt", emit: group_stats_txt
    ...
    # Write output
    write.csv(sample_stats, "trimmed_sample_statistics.csv", row.names = FALSE)
    
    # Write human-readable text report
    sink("trimmed_sample_statistics.txt")
    cat("================================================================================\\n")
    cat("              PER-SAMPLE DESCRIPTIVE STATISTICS (TRIMMED READS)\\n")
    cat("================================================================================\\n\\n")
    cat("Analysis of quality metrics after trimming, averaged across R1 and R2 reads\\n")
    ...
    cat("================================================================================\\n")
    cat("Summary across all samples (AFTER TRIMMING):\\n")
    ...
    # Write output
    write.csv(pair_comparison, "trimmed_read_pair_comparison.csv", row.names = FALSE)
    
    # Write human-readable text report
    sink("trimmed_read_pair_comparison.txt")
    cat("================================================================================\\n")
    cat("                READ PAIR COMPARISON - TRIMMED READS (R1 vs R2)\\n")
    cat("================================================================================\\n\\n")
    cat("Analysis of quality degradation from R1 to R2 after trimming\\n")
    ...
    cat("================================================================================\\n")
    cat("Summary of R2 degradation (AFTER TRIMMING):\\n")
    ...
    if (nrow(bladder_samples) < 2 || nrow(ureter_samples) < 2) {
        ...
        write.csv(group_stats, "trimmed_group_statistics.csv", row.names = FALSE)
        
        sink("trimmed_group_statistics.txt")
        cat("================================================================================\\n")
        cat("             GROUP COMPARISON: BLADDER vs URETER (TRIMMED READS)\\n")
        cat("================================================================================\\n\\n")
        ...
        cat("             GROUP COMPARISON: BLADDER vs URETER (TRIMMED READS)\\n")
        cat("================================================================================\\n\\n")
        cat("Statistical comparison of quality metrics between tissue types after trimming\\n")
